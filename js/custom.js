    ...
    $('[data-svg]').each(function() {
        ...
        waitForElm('.partners__map svg').then((item) => {
            ...
            $('.partners__map__wrapper .rus').on('mouseover', function() {
                ...
                $('.partners__countries_info.rus .partners__countries_info-text').css('opacity', '1')
                $('.partners__countries_info.rus .partners__countries_info-text').css('visibility', 'visible')
                $('.partners__countries_info.rus img').css('z-index', '2');
                $('.partners__countries_info.rus .partners__countries_info-text').css('z-index', '1')
            })
            $('.partners__map__wrapper .rus').on('mouseleave', function() {
                $('.partners__map__wrapper .rus').css('fill', '#DCE0EC');
                $('.partners__countries_info.rus .partners__countries_info-text').css('opacity', '0');
                $('.partners__countries_info.rus .partners__countries_info-text').css('visibility', 'hidden')
                $('.partners__countries_info.rus img').css('z-index', '0')
                $('.partners__countries_info.rus .partners__countries_info-text').css('z-index', '0')
            })
            ...
            $('.partners__map__wrapper .chin').on('mouseover', function() {
                ...
                $('.partners__countries_info.chin .partners__countries_info-text').css('opacity', '1');
                $('.partners__countries_info.chin img').css('z-index', '2');
                $('.partners__countries_info.chin .partners__countries_info-text').css('z-index', '1');
                $('.partners__countries_info.chin .partners__countries_info-text').css('visibility', 'visible')
            })
            $('.partners__map__wrapper .chin').on('mouseleave', function() {
                $('.partners__map__wrapper .chin').css('fill', '#DCE0EC');
                $('.partners__countries_info.chin .partners__countries_info-text').css('opacity', '0');
                $('.partners__countries_info.chin img').css('z-index', '0')
                $('.partners__countries_info.chin .partners__countries_info-text').css('z-index', '0')
                $('.partners__countries_info.chin .partners__countries_info-text').css('visibility', 'hidden')
            ...
            $('.partners__map__wrapper .japan').on('mouseover', function() {
                ...
                $('.partners__countries_info.japan .partners__countries_info-text').css('opacity', '1');
                $('.partners__countries_info.japan img').css('z-index', '2');
                $('.partners__countries_info.japan .partners__countries_info-text').css('z-index', '1');
                $('.partners__countries_info.japan .partners__countries_info-text').css('visibility', 'visible')
            });
            $('.partners__map__wrapper .japan').on('mouseleave', function() {
                $('.partners__map__wrapper .japan').css('fill', '#DCE0EC');
                $('.partners__countries_info.japan .partners__countries_info-text').css('opacity', '0');
                $('.partners__countries_info.japan img').css('z-index', '0')
                $('.partners__countries_info.japan .partners__countries_info-text').css('z-index', '0')
                $('.partners__countries_info.japan .partners__countries_info-text').css('visibility', 'hidden')
            });
            ...
            $('.partners__map__wrapper .eng').on('mouseover', function() {
                ...
                $('.partners__countries_info.eng .partners__countries_info-text').css('opacity', '1');
                $('.partners__countries_info.eng img').css('z-index', '2');
                $('.partners__countries_info.eng .partners__countries_info-text').css('z-index', '1');
                $('.partners__countries_info.eng .partners__countries_info-text').css('visibility', 'visible')
            });
            $('.partners__map__wrapper .eng').on('mouseleave', function() {
                $('.partners__map__wrapper .eng').css('fill', '#DCE0EC');
                $('.partners__countries_info.eng .partners__countries_info-text').css('opacity', '0');
                $('.partners__countries_info.eng img').css('z-index', '0')
                $('.partners__countries_info.eng .partners__countries_info-text').css('z-index', '0')
                $('.partners__countries_info.eng .partners__countries_info-text').css('visibility', 'hidden')
            });
            ...
            $('.partners__map__wrapper .usa').on('mouseover', function() {
                ...
                $('.partners__countries_info.usa .partners__countries_info-text').css('opacity', '1');
                $('.partners__countries_info.usa img').css('z-index', '2');
                $('.partners__countries_info.usa .partners__countries_info-text').css('z-index', '1');
                $('.partners__countries_info.usa .partners__countries_info-text').css('visibility', 'visible')
            });
            $('.partners__map__wrapper .usa').on('mouseleave', function() {
                $('.partners__map__wrapper .usa').css('fill', '#DCE0EC');
                $('.partners__countries_info.usa .partners__countries_info-text').css('opacity', '0');
                $('.partners__countries_info.usa img').css('z-index', '0')
                $('.partners__countries_info.usa .partners__countries_info-text').css('z-index', '0')
                $('.partners__countries_info.usa .partners__countries_info-text').css('visibility', 'hidden')
            });
            ...
            $('.partners__map__wrapper .korea').on('mouseover', function() {
                ...
                $('.partners__countries_info.korea .partners__countries_info-text').css('opacity', '1')
                $('.partners__countries_info.korea img').css('z-index', '2')
                $('.partners__countries_info.korea .partners__countries_info-text').css('z-index', '1')
                $('.partners__countries_info.korea .partners__countries_info-text').css('visibility', 'visible')
            });
            $('.partners__map__wrapper .korea').on('mouseleave', function() {
                $('.partners__map__wrapper .korea').css('fill', '#DCE0EC');
                $('.partners__countries_info.korea .partners__countries_info-text').css('opacity', '0')
                $('.partners__countries_info.korea img').css('z-index', '0')
                $('.partners__countries_info.korea .partners__countries_info-text').css('z-index', '0')
                $('.partners__countries_info.korea .partners__countries_info-text').css('visibility', 'hidden')
            });
            ...
            $('.partners__map__wrapper .uzbek').on('mouseover', function() {
                ...
                $('.partners__countries_info.uzbek .partners__countries_info-text').css('opacity', '1');
                $('.partners__countries_info.uzbek img').css('z-index', '2');
                $('.partners__countries_info.uzbek .partners__countries_info-text').css('z-index', '1');
                $('.partners__countries_info.uzbek .partners__countries_info-text').css('visibility', 'visible')
            });
            $('.partners__map__wrapper .uzbek').on('mouseleave', function() {
                $('.partners__map__wrapper .uzbek').css('fill', '#DCE0EC');
                $('.partners__countries_info.uzbek .partners__countries_info-text').css('opacity', '0');
                $('.partners__countries_info.uzbek img').css('z-index', '0')
                $('.partners__countries_info.uzbek .partners__countries_info-text').css('z-index', '0')
                $('.partners__countries_info.uzbek .partners__countries_info-text').css('visibility', 'hidden')
            });
            ...
            $('.partners__map__wrapper .avst').on('mouseover', function() {
                ...
                $('.partners__countries_info.avst .partners__countries_info-text').css('opacity', '1');
                $('.partners__countries_info.avst img').css('z-index', '2');
                $('.partners__countries_info.avst .partners__countries_info-text').css('z-index', '1');
                $('.partners__countries_info.avst .partners__countries_info-text').css('visibility', 'visible')
            });
            $('.partners__map__wrapper .avst').on('mouseleave', function() {
                $('.partners__map__wrapper .avst').css('fill', '#DCE0EC');
                $('.partners__countries_info.avst .partners__countries_info-text').css('opacity', '0');
                $('.partners__countries_info.avst img').css('z-index', '0')
                $('.partners__countries_info.avst .partners__countries_info-text').css('z-index', '0')
                $('.partners__countries_info.avst .partners__countries_info-text').css('visibility', 'hidden')
            });
            ...
            $('.partners__map__wrapper .afrc').on('mouseover', function() {
                ...
                $('.partners__countries_info.afrc .partners__countries_info-text').css('opacity', '1');
                $('.partners__countries_info.afrc img').css('z-index', '2');
                $('.partners__countries_info.afrc .partners__countries_info-text').css('z-index', '1');
                $('.partners__countries_info.afrc .partners__countries_info-text').css('visibility', 'visible')
            });
            $('.partners__map__wrapper .afrc').on('mouseleave', function() {
                $('.partners__map__wrapper .afrc').css('fill', '#DCE0EC');
                $('.partners__countries_info.afrc .partners__countries_info-text').css('opacity', '0');
                $('.partners__countries_info.afrc img').css('z-index', '0')
                $('.partners__countries_info.afrc .partners__countries_info-text').css('z-index', '0')
                $('.partners__countries_info.afrc .partners__countries_info-text').css('visibility', 'hidden')
            });
            ...
            $('.partners__map__wrapper .india').on('mouseover', function() {
                ...
                $('.partners__countries_info.india .partners__countries_info-text').css('opacity', '1');
                $('.partners__countries_info.india img').css('z-index', '2');
                $('.partners__countries_info.india .partners__countries_info-text').css('z-index', '1');
                $('.partners__countries_info.india .partners__countries_info-text').css('visibility', 'visible')
            });
            $('.partners__map__wrapper .india').on('mouseleave', function() {
                $('.partners__map__wrapper .india').css('fill', '#DCE0EC');
                $('.partners__countries_info.india .partners__countries_info-text').css('opacity', '0');
                $('.partners__countries_info.india img').css('z-index', '0')
                $('.partners__countries_info.india .partners__countries_info-text').css('z-index', '0')
                $('.partners__countries_info.india .partners__countries_info-text').css('visibility', 'hidden')
            });
        });
...
// })
$(".has-childs .has-childs__wrapper").hover(function () {
    $(this).parent().addClass("active")
    $(this).parent().find(".childs").slideDown();
  });
$(".has-childs .childs").mouseleave(function () {
...
$(function() {
    ...
    // Клики по вкладкам.
    $('.programs__buttons a').click(function() {
        tab.hide();
        tab.filter(this.hash).show();
...
$('.mainBlock').css({
    marginTop: '-' + hederHeight + 'px', // делаем отступ у body, равный высоте шапки
})
